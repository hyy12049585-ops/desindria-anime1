// src/components/Cinderino/CinderinoProfileHeader.tsx

import React from "react";
import { useTheme } from "../../contexts/ThemeContext";
import { useCinderinoProfile } from "../../contexts/CinderinoProfileContext";
import { CinderinoProfileStats } from "../../types/cinderino";

interface Props {
  onEditClick: () => void;
}

const CinderinoProfileHeader: React.FC<Props> = ({ onEditClick }) => {
  ...
  const statItems: { label: string; value: number }[] = [
    ...
    { label: "فالوئر", value: stats.followersCount },
    { label: "فالوئینگ", value: stats.followingCount },
  ];
