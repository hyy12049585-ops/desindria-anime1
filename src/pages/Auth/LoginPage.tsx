      ...
      <div className={`relative z-10 w-full max-w-md transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-purple-100/50 border border-white/60 p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-extrabold text-gray-800 mb-2">ورود به سیندریا</h1>
            <p className="text-gray-400 text-sm">برای ادامه، ایمیل و رمز عبور خود را وارد کنید</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex justify-end -mt-2">
              <Link to="/auth/forgot-password" className="text-sm text-purple-500 hover:text-purple-700 transition-colors font-medium">
                فراموشی رمز عبور؟
              </Link>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <p className="text-center text-sm text-gray-500">
              حساب کاربری ندارید؟{' '}
              <Link to="/auth/register" className="text-purple-600 font-bold hover:text-purple-800 transition-colors">ثبت‌نام کنید</Link>
            </p>
          </div>
